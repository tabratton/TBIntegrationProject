...
public class Main {
    ...
    while (loopRunning) { // Loops the choosing of a category
      ...
      while (!goodUserInput) {
        System.out.println("Please choose the category of programs you would"
                ...
                + " of its name: ");
        System.out.println(
                "1. Explanations and Demonstrations and simple" + " things");
  ...
  public static void explainVariableTypes() {
    ...
    System.out.println("short: A 16-bit integer. Has a minimum value of -32,"
            + " 168 and a maximum of 32,767. Example: "
  ...
  public static void checkIfAbsoluteValueIsEqual(final Scanner scanner) {
    ...
    if (num1 == num2) {
      equal = true;
      System.out.println(
              equal + ", the absolute values of the numbers are" + " equal");
    } else if (num1 != num2) {
      equal = false;
  ...
  public static void findThreeAndFiveMultiples(final Scanner scanner) {
    ...
    for (int sumThreeCounter = 0; sumThreeCounter < input; sumThreeCounter += 3) {
      sumThree += sumThreeCounter;
    }
    for (int sumFiveCounter = 0; sumFiveCounter < input; sumFiveCounter += 5) {
      sumFive += sumFiveCounter;
    }
    for (int sumFifteenCounter = 0; sumFifteenCounter < input; sumFifteenCounter += 15) {
  ...
  public static void calculateSimpleInterest(final Scanner scanner) {
    ...
    System.out.println(
            "The value of the investment after one year is: " + principal);
    System.out.println("");
  }
  ...
  public static void convertCelsiusToFahrenheit(final Scanner scanner) {
    ...
    System.out
            .println("The temperature in Fahrenheit is: " + fahrenheitDegrees);
    System.out.println("");
  }
  ...
  public static void convertSpaceWeight(final Scanner scanner) {
    ...
    System.out
            .println("Your weight in pounds on that planet is: " + earthWeight);
    System.out.println("");
  }
  ...
  public static void findSumOfFiveNumbers(final Scanner scanner) {
    ...
    int number;
    System.out.println(
            "Please enter the number of integers you would like to" + " add: ");
  ...
  public static void slopePoint(final Scanner scanner) {
    ...
    do {
      try {
        System.out.println(
                "Please enter the x coordinate of the current" + " point: ");
        double x1 = scanner.nextInt();
        System.out.println(
                "Please enter the y coordinate of the current" + " point: ");
        double y1 = scanner.nextInt();
        System.out.println(
                "Please enter the x coordinate of the target" + " point: ");
        double x2 = scanner.nextInt();
        System.out.println(
                "Please enter the y coordinate of the target" + " point: ");
